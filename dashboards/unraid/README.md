...
| <img src="/dashboards/unraid/img/containers-indicatorw.gif"> | Containers can be turned toggled (on/off) from the Green Indicator Circle (confirmation popup). High CPU and bandwith cues for each container. |
